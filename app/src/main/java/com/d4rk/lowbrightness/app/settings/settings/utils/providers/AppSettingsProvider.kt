        ...
        return SettingsConfig(
            title = context.getString(R.string.settings), categories = listOf(
                ...
                SettingsCategory(
                    preferences = listOf(
                        SettingsPreference(
                            key = SettingsConstants.KEY_SETTINGS_BRIGHTNESS,
                            icon = Icons.Outlined.Brightness7,
                            title = context.getString(com.d4rk.lowbrightness.R.string.settings_brightness_title),
                            summary = context.getString(com.d4rk.lowbrightness.R.string.settings_brightness_summary),
                            action = {
                                GeneralSettingsActivity.start(
                                    context = context,
                                    title = context.getString(com.d4rk.lowbrightness.R.string.settings_brightness_title),
