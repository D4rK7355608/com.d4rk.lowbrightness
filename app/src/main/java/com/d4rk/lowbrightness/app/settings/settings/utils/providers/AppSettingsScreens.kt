...
import com.d4rk.lowbrightness.app.settings.brightness.ui.BrightnessSettingsScreen
...
class AppSettingsScreens {
    val customScreens : Map<String , @Composable (PaddingValues) -> Unit> = mapOf(
        SettingsConstants.KEY_SETTINGS_BRIGHTNESS to { paddingValues -> BrightnessSettingsScreen(paddingValues) })
}
